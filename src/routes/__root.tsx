...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "LAB INTELLIGENCE — A fronteira da inteligência sintética" },
      { property: "og:description", content: "Gestão inteligente de laboratórios com visão em tempo real." },
